...
public class smaple_pane extends JFrame {
 private JScrollPane scrollPane = null;
 private JTextPane text = null;
 private JTextPane another_text = null;
 ...
 private StyledDocument docold = null;
 ...
 public smaple_pane() {
  ...
  text = new JTextPane();
  another_text = new JTextPane();
  text.setEditable(false);
  doc = text.getStyledDocument(); // 获得JTextPane的Document
  docold = text.getStyledDocument();
